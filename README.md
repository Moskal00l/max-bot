...
### 1. Главное экран
![Здесь должно быть фото](max_bot/images/IMG_4560.png)

### 2. Создание события
![Здесь должно быть фото](max_bot/images/IMG_4561.png)

### 3. Страница события
![Здесь должно быть фото](max_bot/images/IMG_4566.png)

### 4. Сканер QR-кодов
![Здесь должно быть фото](max_bot/images/IMG_4597.png)
